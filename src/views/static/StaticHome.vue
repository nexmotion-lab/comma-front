<template>
    ...
    <div class="home">
      ...
      <div v-if="showNewMoreModal" class="modal">
        <div class="more-modal-content">
          <p>2024년 3월 (닉네임)가 많이 선택한 감정들을 정리해봤어!</p>
          <div class="emotion-summary">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const showNewMoreModal = ref(false); // New modal state
  ...
  .modal-content, .more-modal-content, .new-more-modal-content {
    background-color: #ffffff;
    padding: 20px;
    border-radius: 10px;
    text-align: center;
  ...
  .more-modal-content, .new-more-modal-content {
    text-align: center;
  }
  ...
  .more-modal-content p, .new-more-modal-content p {
    font-size: 16px;
    margin-bottom: 20px;
  }
