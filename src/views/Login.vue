...
export default defineComponent({
  ...
  methods: {
    handleSocialLogin(event: Event, provider: string) {
      event.preventDefault()
      // 소셜 로그인 URL로 리다이렉션
      window.location.href = `http://localhost:8084/oauth2/authorization/${provider}?{registrationId}`
    },
    handleRedirection() {
...
<template>
  <ion-page>
    <div class="login-container">
      ...
      <!--      <a href="http://www.naver.com" class="social-buttons" id="naver-connect">-->
      <!--        <span>네이버 로그인</span></a-->
      <!--      >-->
      <!--      <a href="http://www.kakao.com" class="social-buttons" id="kakao-connect">-->
      <!--        <span>카카오 로그인</span></a-->
      <!--      >-->
      <!--      <a href="http://www.google.com" class="social-buttons" id="google-connect">-->
      <!--        <span>Google 로그인</span></a-->
      <!--      >-->
...
#naver-connect {
  background: #03c75a url('../assets/naver_login.png') no-repeat scroll 5px 0 / 50px 50px
...
#google-connect {
  background: rgb(255, 255, 255) url('../assets/google_login.png') no-repeat scroll 5px 0px / 50px
...
#kakao-connect {
  background: #fee500 url('../assets/kakao_login.png') no-repeat scroll 5px 0px / 50px 50px
    padding-box border-box;
}
