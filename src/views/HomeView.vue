...
export default {
  ...
  setup() {
    ...
    const interactions: Interaction[] = [
      ...
      { id: 8, imageUrl: "/src/assets/action8-2.png", text: "오래 살아보니 알겠다, 꾸준함이 재능이고, 그 꾸준함은 좋아하는 마음에서 나온다는 것을.<br>좋아하는 것을 찾으세요. 당신은 천재가 됩니다." },
...
.speech-bubble:after {
  ...
  border: 2px solid white; /* 꼬리의 테두리 색 */
  ...
  0 4px 4px rgba(100,100,100,0.11),
  0 6px 8px rgba(100,100,100,0.11),
  0 8px 16px rgba(100,100,100,0.11);
}
...
.background-img {
  ...
  top: 30%;
  z-index: 0;
  filter: drop-shadow(5px 12px 8px #BDD2BD);
}
